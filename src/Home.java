    ...
    static int lastIndex;
        ...
        public void forecast() throws IOException {
            ...
            if (enkucuk == FirstMethod.error()) {
                System.out.println(" Exponential Smoothing Method");
            } else if (enkucuk == SecondMethod.error()) {
                System.out.println(" Double Exponential Smoothing Method");
            }else if (enkucuk == ThirdMethod.error()) {
                System.out.println(" Regression Analysis Method");

            }else if (enkucuk == FourthMethod.error()) {
                System.out.println(" Deseasonalized Regression Analysis Method");
            }

            for (int i = 24; i < 48; i++) {

                    if (enkucuk == FirstMethod.error()) {
                        System.out.println((i - 23) + ". month of next date: " + FirstMethod.calculation().getByPosition(i).getName());
                        ...
                        System.out.println((i - 23) + ". month of next date: " + SecondMethod.calculation().getByPosition(i).getName());
                        ...
                        System.out.println((i - 23) + ". month of next date: " + ThirdMethod.calculation().getByPosition(i).getName());
                        try {
                        ...
                        System.out.println((i - 23) + ". month of next date: " + FourthMethod.calculation().getByPosition(i).getName());
                        try {
        ...
        public void insertNewDataset() throws IOException {
            ...
            for (int i = 0; i < 24; i++) {
                System.out.println("please input " + (i + 1) + ". mounth");
        ...
        public void listAllDatasets() {
            ...
            try {
                ...
                while (lister.hasNextLine()) {
                    ...
                    System.out.println("dataset "+(i+1)+": "+line);
                    i++;
                }
                lister.close();
    ...
    public static int[] data2() throws FileNotFoundException {
        ...
        public void searchValueOnDataSet(int search) throws FileNotFoundException {
            ...
            while (x.hasNextInt()) {
                ...
                if (x.nextInt()==search) {
                    System.out.println((i)+". month " + search);
                }
                i++;
